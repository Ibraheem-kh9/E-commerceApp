...
class BadgesCartWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return badges.Badge(
      ...
      showBadge: true,
      ignorePointer: false,
      badgeStyle : badges.BadgeStyle(badgeColor: Colors.transparent,padding: EdgeInsets.all(0.6.h),borderSide: BorderSide.none,elevation: 0,),
      badgeContent: Consumer<CartViewModel>(
        builder: (context, cartNotify, child) {
          return cartNotify.getCounter() > 0 ?Text(
