                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CartTextWidget(
                            text:
                                'Price: ${cartViewModel.addItemToCart[index].itemPrice} \$',
                            fontSize: 11.sp,
                            fontColor: AppColor.kIconColor,
                          ),
                          CartTextWidget(
                            text:
                                'Qty: ${cartViewModel.addItemToCart[index].itemQty!}',
                            fontSize: 12.sp,
                            fontColor: AppColor.kDefaultTextColor,
                          ),
                        ],
                            ...
                            CartItemBtnSection(
                              onPress: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return OrderItemSc(
                                    index: notify.addItemToCart[index].itemId,
                                    product: context.read<ProductViewModel>().productModelView![notify.addItemToCart[index].itemId!],
                                    productViewModel: context.read<ProductViewModel>(),
                                  );
                                }));
                                // Navigator.pushNamed(
                                //     context, AppRoute.itemDetailOrderSc,
                                //     arguments: {
                                //       'index': index,
                                //       'product' : context.read<ProductViewModel>().productModelView![index],
                                //
                                //     });
                              },
                              iconData: Icons.edit,
